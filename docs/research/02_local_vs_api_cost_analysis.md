...
Costs per run below are computed from the **input/output** rates (not the blended column), using the 40k/5k token split. These values replace earlier heuristic estimates.
